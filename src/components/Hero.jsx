...
export default function Hero() {
    ...
    return (
        <div className="pt-3 xl:pt-10 lg:pt-8 md:pt-6 hero-image xl:flex lg:flex md:flex flex-none justify-between  xl:pl-[125px] xl:pr-[175px] lg:pl-[100px] lg:pr-[150px]  sm:pl-[60px] sm:pr-[90px] pl-[20px] pr-[30px]">
        ...
        <div className=' mt-3 xl:mt-10 lg:mt-5'><img src="hero2.png"  className=" rounded-2xl w-[476px] h-[375px] " alt='heroprofilfoto'/></div>
        </div>
